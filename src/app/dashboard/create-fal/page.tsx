...
export default function CreateFalVideoPage() {
  ...
  const handleContinueToStyle = () => {
    ...
    router.push(`/dashboard/create-fal/style?${params.toString()}`);
  };
      ...
      <div className="container max-w-3xl py-8 px-4 mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-bold tracking-tight">
            Create AI Testimonial
          </h1>
          <p className="text-muted-foreground mt-2">
            Transform your review into a lip-synced video testimonial with AI-powered actors.
          </p>
        </motion.div>
        ...
        >
          <Card className="border-border/50 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Paste your customer review and we&apos;ll transform it into a
                professional lip-synced video testimonial.
              </CardDescription>
            </CardHeader>
            <CardContent>
